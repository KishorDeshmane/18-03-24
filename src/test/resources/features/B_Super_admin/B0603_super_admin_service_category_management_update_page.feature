...
Feature: Validate super admin service category management update page functionality
  ...
  Scenario: Validate that elemets is present with super admin service category management edit page
    ...
    Then Verify that parent category title text above the user field should be displayed in super admin service category management edit page
 		...
 		Then Verify that parent category search user field should be clickable in the super admin service category management edit page
    Then Verify that parent category search placeholder value should be "Enter parent category name" in super admin service category management edit page
