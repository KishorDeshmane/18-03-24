...
Feature: Validate super admin create service category page functionality
  ...
  Scenario: Validate that elemets is present with super admin create service category page
    ...
    Then Verify that parent category search user field should be clickable in the super admin create service category page
    Then Verify that parent category search placeholder value should be "Enter parent category name" in super admin create service category page
